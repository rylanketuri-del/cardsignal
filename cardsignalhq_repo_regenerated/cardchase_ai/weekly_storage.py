...
class WeeklyStorage:
    ...
    def _player_snapshot_to_row(self, snap: PlayerWeeklySignalSnapshot) -> dict[str, Any]:
        return {
            ...
            "weekly_algorithm_version": snap.weekly_algorithm_version,
            "scoring_algorithm_version": snap.scoring_algorithm_version,
    ...
    def _signal_to_row(self, signal: SignalOfTheWeek) -> dict[str, Any]:
        return {
            ...
            "weekly_algorithm_version": signal.weekly_algorithm_version,
            "scoring_algorithm_version": signal.scoring_algorithm_version,
